...
The data tables and figures from the meadow surveys data analysis are presented here with minimal explanation but in a printable form for easy reference. A set of bipartite graphs showing the relationship between species and sites for each latent community is also included [(Section 4)](#section4); these were not shown in the main document [The River Ouse Project: Meadow Surveys Data Analysis](https://rpubs.com/Zygodon/1040095)

## 1. Latent community membership tables.

These are lists of the plants in each latent community. The count column is the number of times the plant was observed at a site; the frequency is frequency of occurrence on a site basis expressed as %.
...
## 3. Community expressions by site, polar plots.
